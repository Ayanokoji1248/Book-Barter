...
const style = {
    ...
    rejected: "text-red-500 px-3 py-1 font-medium text-xs rounded-full bg-red-100 w-fit ",
    accepted: "text-green-500 px-3 py-1 font-medium text-xs rounded-full bg-green-100 w-fit ",
